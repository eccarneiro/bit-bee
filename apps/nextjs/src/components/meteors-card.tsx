  ...
  return (
    <div className="w-full">
      <div className="relative w-full">
        ...
        <div className="relative flex h-full flex-col items-start justify-end overflow-hidden rounded-2xl px-4 py-8 shadow-xl dark:bg-gray-900 dark:bg-opacity-70">
